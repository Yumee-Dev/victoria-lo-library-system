...
var booksReducer = function booksReducer() {
  ...
  switch (action.type) {
    ...
    case DELETE_BOOK:
      ...
      return Object.assign({}, state, { books: state.books.slice(0, index).concat(state.books.slice(index + 1)) });
    case FILL_BOOKS:
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.props.books.map(function (book) {
              return BookTileComponent({ book: book, deleteBook: _this3.deleteBook, editBook: _this3.editBook, turnOnLoading: _this3.turnOnLoading, turnOffLoading: _this3.turnOffLoading });
            })
          ),
          this.props.addBookFormVisible ? React.createElement(AddBookComponent, { hideAddBookForm: this.hideAddBookForm, addBook: this.addBook, turnOnLoading: this.turnOnLoading, turnOffLoading: this.turnOffLoading }) : null
        )
      );
    }
  }]);
...
var BookTileComponent = function BookTileComponent(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'button',
        { className: 'btn book-tile__btn', onClick: props.editBook, 'data-id': props.book.id },
        'Edit'
      )
    )
  );
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { type: 'text', id: 'title', name: 'title', onChange: this.handleTitleChange, maxlength: '64', placeholder: 'The Great Gatsby', required: true })
          ),
          React.createElement(
            'section',
            null,
            ...
            React.createElement('input', { type: 'text', id: 'author', name: 'author', onChange: this.handleAuthorChange, maxlength: '64', placeholder: 'F. Scott Fitzgerald', required: true })
          ),
          React.createElement(
            'section',
            null,
            ...
            React.createElement('textarea', { id: 'annotation', name: 'annotation', onChange: this.handleAnnotationChange, maxlength: '512', rows: '8', placeholder: 'The Great Gatsby is a 1925 novel by American writer F. Scott Fitzgerald. Set in the Jazz Age on Long Island, near New York City, the novel depicts first-person narrator Nick Carraway\'s interactions with mysterious millionaire Jay Gatsby and Gatsby\'s obsession to reunite with his former lover, Daisy Buchanan.' })
          ),
          React.createElement(
            'button',
            { type: 'submit', className: 'btn', id: 'btn-add-book', onClick: this.submitAddBook },
            'Add book'
          )
        )
      );
